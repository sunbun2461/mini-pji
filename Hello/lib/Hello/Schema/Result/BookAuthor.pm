use utf8;
package Hello::Schema::Result::BookAuthor;
...
Related object: L<Hello::Schema::Result::Author>
...
Related object: L<Hello::Schema::Result::Book>

=cut

__PACKAGE__->belongs_to(
  "book",
  "Hello::Schema::Result::Book",
  { id => "book_id" },
  { is_deferrable => 0, on_delete => "CASCADE", on_update => "CASCADE" },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:BLrnro6tYBsSgkhY1n6GyQ
